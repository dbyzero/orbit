...
export function updateScene(delaySinceLastUpdateInMs) {
    items.avatar5.position.x = items.avatar5.position.x + 2.6 * delaySinceLastUpdateInMs;
}

export function loadCollisionLayer(scene, collisionLayer) {
